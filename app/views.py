...
def signup(request):
    ...
    user.save()
    return JsonResponse({'status_code': 200, 'message': 'User created'})
...
def signin(request):
    ...
    if user is not None:
        login(request, user)
        return JsonResponse({'status_code': 200, 'message': 'User logged in'})
    return JsonResponse({'status_code': 403, 'message': 'Invalid credentials'})


def signout(request):
    logout(request)
    return JsonResponse({'status_code': 200, 'message': 'User logged out'})
...
def get_user(request):
    ...
    return JsonResponse({'status_code': 200, 'message': 'User found', 'data': data})
...
def update_user(request):
    ...
    if password:
        if password != user.password:
            ...
            return JsonResponse({'status_code': 400, 'message': 'Password is same as before'})
    user.save()
    return JsonResponse({'status_code': 200, 'message': 'User updated'})
